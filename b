...
game.StarterGui:SetCore("SendNotification", {
    Title = "VITEN  ";
    Text = " لقد تم التفعيل "; -- ARAB TEAM
    Duration = 5;
})
local args = {
    [1] = "RolePlayName",
    [2] = "تم تفعيل سكربت المطور VITEN "
}
...
local args = {
    [1] = "RolePlayBio",
    [2] = "Developer script activated VITEN"}

game:GetService("ReplicatedStorage").RE:FindFirstChild("1RPNam1eTex1t"):FireServer(unpack(args))
wait(0.5)
game.StarterGui:SetCore("SendNotification", {
    Title = "تم تطوير سكربت من قبل VITEN ";
    Text = "VITEN "; -- ARAB TEAM
    Duration = 5;
})

loadstring(game:HttpGet(("https://raw.githubusercontent.com/alimahdy1/Itachi-Brookhaven-/refs/heads/main/h")))()
MakeWindow({
  Hub = {
    Title = " new|viten",
    Animation = " new|viten "
...
MinimizeButton({
  Image = "rbxassetid://129371791004427",
  Size = {50, 50},
...
local Image = AddImageLabel(Main, {
  Name = "Bhitchs they come they come 🫴🏻!",
  Image = "rbxassetid://129371791004427"
})
...
AddButton(Main, {
  Name = "حسابي الروب",
  Callback = function()
    setclipboard('akramnene')
  end
})

local Main = MakeTab({Name = "--Brookhaven--"})

AddButton(Main, {
  Name = "--سكربت مارتن--",
  Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Martin19087/Martin/refs/heads/main/Martin6"))() 
  end
})
...
AddButton(Main, {
  Name = "--سكربت طيران--",
  Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/tojiBrookhaven/Toji/refs/heads/main/طيران"))()
  end
})
...
local Main = MakeTab({Name = "--صملات+حماية--"})
local Paragraph = AddParagraph(Main, {"--حماية--"})
...
AddButton(Main, {
  Name = "--سكربـت محد يقدر يطيركـك--",
  Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/zephyr10101/ignore-touchinterests/main/main",true))() 
  end
})

local Paragraph = AddParagraph(Main, {"--صملات متنوعة-- "})
AddButton(Main, {
  Name = "AFK[1] ",
  Callback = function()
...
AddButton(Main, {
  Name = "AFK [6] ",
  Callback = function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-asgf-syugfGF-v-5831"))()
  end
})
...
local Paragraph = AddParagraph(Main, {"--اجسام بنات--"})
...
local Main = MakeTab({Name = "--الشعور--"})
local Paragraph = AddParagraph(Main, {"!!ملاحضة لمن تريد تنسخ شعر  وخر كل الايتمات عشان يضبط عندك!!"})
...
local section = AddSection(Main, {"--ادخل كود الاغنية--"})
 
AddTextBox(Main, {
  Name = "ادخل كود الاغنية",
  Default = "",
  PlaceholderText = "ادخل الاغنيه سكيت بورد",
  ClearText = true,
...
AddButton(Main, {
  Name = " اضغط لنسخ كود قوي و صوته عالي FUNK15",
  Callback = function()
    setclipboard('‎111092240241909 ')
  end
})
...
local Main = MakeTab({Name = "--تنقل-Teleport--"})
...
local Paragraph = AddParagraph(Main, {" --ادخل كود الاغنية--"})

AddTextBox(Main, {
  Name = "ادخل كود الاغنية",
  Default = "",
  PlaceholderText = "ادخل الاغنيه سيارة ",
  ClearText = true,
  Callback = function(Value)
local args1 = {
            [1] = "SkateBoard"
...
local Paragraph = AddParagraph(Main, {" --خصائص السيارة--"})
...
local section = AddSection(Main, {"--ازالة الحضر من البيت--"})
